...
let player = [
    ...
    ['Aabel03.png',
     ...
     11,
     '5/25/2021'],
    ['PlayerAaritSk.png', //AaritMehta | Change your name one more time and I will scream
	 'PlayerAaritSk',
	 958,
	 19654,
	 2270,
    ...
    ['AlphaZero.png',
     ...
     5032,
     80270,
     1969, // rip impressive no bot kills streak!
     33841,
     '2.37',
     60,
     '11/4/2021'],
    ...
    ['Bro Man.jpg',
     ...
     30,
     '8/4/2021'],
    ['TheVladyBoi.png', // RocketLeague aka ! Wodahs Maet KsTakWodahs !
     'TheVladyBoi',
     3277,
     49954,
     3711,
    ...
    ['CATwithHAT.jpg',
	 ...
	 32,
	 '8/11/2021'],
    ['EREDOTEI.png', //Voodogage 2.1#0728
     'EREDOTEI',
     13,
     322,
     9,
    ...
    ['FireStorm.png',
     ...
     '',
     '6/03/2021'],
    ['Player2.png', // Tanveer_Singh#9458 or ForFamily
	 'Player2',
	 612,
	 9617,
	 263,
    ...
    ['Guardian.png', //Guardian#0826
     ...
     20526,
     '1.48',
     60, // I can't tell if the jump from 15 to 54 is realistic or not................ hmmmmmmmmmmm
     '11/4/2021'],
    ['Hackbuster.png',
	 'Hackbuster' + newPlayer,
	 3096,
	 51924,
	 3513,
	 30441,
    ...
    ['Harmlesscheese.jpg',
     ...
     13,
     '6/09/2021'],
    ['Hello.png', //Asianhawksr#6734
     'Hello',
     59,
     1030, // GT 1030 lets go please graphics card prices 😂😭😭
     119,
     847,
     '1.22',
     12,
     '11/4/2021'],
    ['Henry.png', //Henry (⌐■_■)#1723
	 'Henry' + newPlayer,
	 771,
	 12827,
	 752,
	 ...
	 37,
	 '11/4/2021'],
    ['HeXInFerN0.png', // TheHyPeRB0LA#7545
	 'HeXInFerN0',
	 1386,
	 24477,
	 875,
    ...
    ['KAVINDU.png',
	 ...
	 23,
	 '8/27/2021'],
    ['JAW.png', //KFxium1 🅲🅰🆁🅽🅰🅶🅴#7802 or carnage if searching with normal letters
     'JAW',
     168,
     2599,
     411,
    ...
    ['kps.png',
     ...
     '',
     ''],
    ['LadyGripReaper.png', //EerieNourawr #𝓣𝓮𝓪𝓶𝓗𝓪𝓵𝓬𝔂𝓸𝓷 Noura~#5726 and nope I'm not changing the name any more. (they wanted to change to LadyGrimReaperOnDrugs)
	 'LadyGripReaper',
	 1118,
	 15659,
	 1121,
    ...
    ['AUTIST.png',
	 ...
	 10,
	 '11/4/2021'],
    ['axelsen curry yagood.png',
	 'axelsen curry yagood' + newPlayer,
	 350,
	 8705,
	 1070,
	 6508,
    ...
    ['nicrone.png',
	 ...
	 30,
	 '11/4/2021'],
    ['NIGHTMARE.png', // ADI-SPOT#3515 changed name to YOUR BAD NIGHTMARE#4642 apparently but now their discord account is deleted so someone else got this name lol!!!
	 'NIGHTMARE',
	 401,
	 10495,
	 509,
    ...
    ['Oogway.jpg',
     ...
     10,
     '6/16/2021'],
    ['OscarBumper2sk.png', //OscarAwardNOTHING#2050
	 'OscarBumper2sk',
	 247,
	 10267,
	 976,
    ...
    ['PANDA.png', // ClikityClak#6475
	 ...
	 31,
	 '10/17/2021'],
    ['PandaExpress1.png', //bruh why change your name to have a 1 at the end SMH
	 'PandaExpress1',
	 1056,
	 21929,
	 72,
	 13814,
	 '1.59',
	 51, // grats on gems tho
	 '11/4/2021'],
    ['AlphaBro.png', // smh name changes :angry: also this was PandaSK / Cocolon / Retired SK pro
	 'AlphaBro',
	 975,
	 15886,
	 549,
    ...
    ['Player Cobra Kai.png',
     ...
     3,
     '5/18/2021'],
    ['PlayerhafeezSK.png', //SK beast#2868
	 'PlayerhafeezSK' + newPlayer,
	 1293,
	 25016,
	 827,
	 17038,
    ...
    ['Spookster.png', // ProMaster
     ...
     26658,
     '2.29',
     '', // smh post your level in the screenshot :eyes: (part 2)
     '11/4/2021'],
    ['punya fanyz.png',
	 'punya fanyz',
	 266,
    ...
    ['RastaQueen.png',
     ...
     '',
     '5/28/2021'],
     ['sarthak.png', // sarthak#2091 captain reddy-sarthak#2091
     'sarthak',
     2806,
     48197,
     2580,
    ...
    ['seanysean.png',
     ...
     2996,
     55062,
     489 + 253 + 64, // smh disappointing bruh
     31138,
     '1.77',
     60,
     '11/4/2021'],
    ...
    ['SMASH BOI.png',
     ...
     15,
     '5/28/2021'],
    ['smash karts.png', //smash karts#9842
	 'smash karts',
	 887,
	 17228,
	 672,
    ...
    ['SummerXGems.png',
	 ...
	 15,
	 '9/17/2021'],
    ['SUPERCOMMANDODHRUV.png', //HambinoHamburgur#6089
	 'SUPERCOMMANDODHRUV',
	 1296,
	 19668,
	 1250,
    ...
    ['Supremo.png',
     ...
     '1.20',
     6,
     '11/4/2021'], // yo someone updated for first time since before dates were included
    ['suyashsvc.png',
	 'suyashsvc',
	 38,
	 2116,
    ...
    ['Tesla K.png',
	 ...
	 20,
	 '8/19/2021'],
    ['THANOS.png', // THANOS (fall team's thor)#1062
	 'THANOS',
	 911,
	 11675,
	 1168,
    ...
    ['TheCook.png',
     ...
     '',
     ''],
    ['theworstplayer.png', //Hobbes#5216
	 'theworstplayer',
	 492,
	 9089,
	 453,
	 ...
	 34,
	 '11/4/2021'],
    ['xAncientNOVAx.png', //ThunderNOVA#2600
     'xAncientNOVAx',
     956,
     14472,
     750,
    ...
    ['Yoshi.png',
     ...
     13,
     '6/16/2021'],
    ['yourdog.png', //Hamster#0898 Kurama#4342
	 'yourdog',
	 544,
	 10004,
	 602,
